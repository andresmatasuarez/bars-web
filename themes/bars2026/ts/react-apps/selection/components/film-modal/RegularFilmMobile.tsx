    ...
    <div className="relative flex-1 min-h-0">
      <div className="absolute inset-0 overflow-y-auto pt-16">
        ...
        <div className="flex flex-col gap-6 px-5 pt-6 pb-[85px]">
            ...
            <div className="flex flex-col gap-3">
              ...
              {movie.cast && (
                <div className="flex gap-2">
                  ...
                  <span className="text-sm text-white leading-[1.5]">{movie.cast}</span>
                </div>
              )}
            </div>
          )}
          ...
          {movie.synopsis && (
            <div className="flex flex-col gap-3">
              <h3 className="font-heading text-[22px] font-medium text-white">Sinopsis</h3>
              <div
          ...
          {movie.trailerUrl && movie.thumbnail && (
            <div className="flex flex-col gap-3">
              <h3 className="font-heading text-[22px] font-medium text-white">Trailer</h3>
              <TrailerEmbed trailerUrl={movie.trailerUrl} thumbnail={movie.thumbnail} compact />
            </div>
          )}
          {/* Screenings */}
          {movie.screenings.length > 0 && (
            <div className="flex flex-col gap-3">
              <h3 className="font-heading text-[22px] font-medium text-white">Funciones</h3>

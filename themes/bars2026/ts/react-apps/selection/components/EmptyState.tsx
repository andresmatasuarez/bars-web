...
export default function EmptyState({ type }: Props) {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-sm text-bars-text-subtle max-w-xs">
          Agregá películas tocando el ícono de marcador en cada tarjeta para
          armar tu propia grilla.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="text-sm text-bars-text-subtle max-w-xs">
        No se encontraron películas con los filtros seleccionados. Probá
        cambiando la sección o el día.
      </p>
    </div>
  );
}

...
export function MonitorPlayIcon({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LayoutGridIcon({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SearchXIcon({ size = 24, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M13.5 8.5l-5 5M8.5 8.5l5 5M21 21l-4.3-4.3M19 11a8 8 0 1 1-16 0 8 8 0 1 1 16 0z" />
    </svg>
  );
}

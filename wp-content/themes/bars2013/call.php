							...
							<div class="bars-info-displayer-content">
								<div class="bars-info-displayer-header">
									...
									<div class="bars-info-displayer-header-title">
										BASES XV Festival Buenos Aires Rojo Sangre
									</div>
									<div class="bars-info-displayer-header-caption">[ recepción hasta: 1 de agosto de 2014 ]</div>
								</div>
								<div class="scratch"></div>
								<div class="bars-hidden-info text-opensans">
									<span class="text-oswald size-highlight">
										XV Festival Buenos Aires Rojo Sangre
									</span>
									<br />
									<span class="text-oswald">
									...
									<ul>
										...
										<li>
											<strong>La inscripción al festival no tiene ningún costo.</strong>
										</li>
										<li>
										...
										<li>
											En caso de que la película sea seleccionada para participar, la organización del festival se pondrá en contacto con los realizadores para analizar el formato en que se realizará la proyección.<br />
											Los largometrajes se proyectarán en 35mm, DCP, DVD, Blu-Ray, Betacam o DVcam.<br />
											Los cortometrajes se proyectarán en DVD o en HD 720p sólo con la siguiente exportación (enviar sin menú, sin barras de ajuste y con 3 segundos de negro):
											<div class="shortfilm-format">
												Códec H.264<br />
												Resolución: 720p (standard)<br />
												Canales de Audio: 2 (estéreo)<br />
												Audio Sample Rate: 48kHz<br />
												Audio Bit Depth: 16 ó 24 bits<br />
											</div>
										</li>
										<li>
											El festival estará dividido en diferentes secciones:
											<ol>
												<li>Sección competitiva de largometrajes de producción posterior al 1 de enero de 2013.</li>
												...
												<li>Secciones internacional competitiva de cortometrajes para películas en cualquier formato, de cualquier país de origen, <strong>con una duración máxima de 25 minutos</strong>, con producción posterior al 1 de enero de 2013.</li>
												<li>Secciones informativas de cortometrajes y mediometrajes, no competitivas, sin limitación de fechas, formato o duración.</li>
											</ol>

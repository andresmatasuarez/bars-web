...
export default function pressForm() {
  ...
  $('#press-form').validate({
    rules: {
      accredited_name: { required: true, maxlength: 50 },
      accredited_id: { required: true, maxlength: 50 },
      accredited_city: { required: true, maxlength: 50 },
      accredited_country: { required: true, maxlength: 20 },
      accredited_mobile: { required: true, maxlength: 20 },
      accredited_email: { required: true, maxlength: 100, email: true },
      press_media_name: { required: true, maxlength: 50 },
      press_media_editor: { required: true, maxlength: 50 },
      press_media_contact: { required: true, maxlength: 50 },
      press_media_city: { maxlength: 50 },
      press_media_country: { maxlength: 50 },
    },
